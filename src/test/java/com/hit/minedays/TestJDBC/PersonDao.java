...
public class PersonDao {
    ...
    public void addPerson(Person g) throws SQLException {
        ...
        //sql
        String sql = "INSERT INTO tab_person(userName,profileImg,email,gender,enableStatus,userType,createTime,lastEditTime)\n" +
                "                       VALUES\n" +
        ...
        ptmt.setString(2, g.getProfileImg());
        ptmt.setString(3, g.getEmail());
        ptmt.setString(4, g.getGender());
        ptmt.setInt(5, g.getEnableStatus());
        ptmt.setInt(6, g.getUserType());
